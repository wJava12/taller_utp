                            ...
                            <div class="col-lg-12">
                                <div class="ml-3 mr-3 p-4">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Actualizar Articulos</h1>
                                    </div>
                                    ...
                                    <form action="articuloMan" class="user" method="post">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                              ...
                                              <input type="text" pattern="[a-zA-Z ]{3,45}" name="txtNombre" class="form-control" id="inputNombre" placeholder="Nombre" value="<%=articulo.getNombre()%>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputApellido" class="col-sm-4 col-form-label">Cantidad</label>
                                            <div class="col-sm-8">
                                              <input type="text" name="txtCantidad" pattern="^[0-9]+" class="form-control" id="inputApellido" placeholder="Cantidad" value="<%=articulo.getCantidad()%>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputTelefono"  class="col-sm-4 col-form-label">Precio</label>
                                            <div class="col-sm-8">
                                              <input type="text" name="txtPrecio" pattern="^[0-9]{1,5}(\.[0-9]{0,4})?$" class="form-control" id="inputTelefono" placeholder="Precio" value="<%=articulo.getPrecio()%>">
                                            </div>
                                        </div>
                                                                              
                                        
                                       
                                        <input type="hidden" id="tipo" name="tipo" value="actualizar_articulo">
