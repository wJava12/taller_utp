                            ...
                            <div class="col-lg-12">
                                <div class="ml-3 mr-3 p-4">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Registro de Articulos</h1>
                                    </div>
                                    ...
                                    <form action="articuloMan" class="user" method="post">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                              <input type="text" name="txtCantidad" pattern="^[0-9]+" class="form-control" id="inputApellido" placeholder="Cantidad">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputTelefono"  class="col-sm-4 col-form-label">Precio</label>
                                            <div class="col-sm-8">
                                              <input type="text" name="txtPrecio" pattern="^[0-9]{1,5}(\.[0-9]{0,2})?$" title="Ingresa solo numeros con 0 - 2 decimales" class="form-control" id="inputTelefono" placeholder="Precio">
                                            </div>
                                        </div>
                                        ...
                                        <input type="hidden" id="tipo" name="tipo" value="registrar_articulo">
